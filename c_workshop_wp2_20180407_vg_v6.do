...
5th July 2018 Sarah Stopforth corrects minor errors.
...
in Stata version 14 it is "ci mpg"

in Stata version 15 the command has been extended and the syntax has changed
...
Question: What percentage of the cars are not produced in the US (i.e. are foreign)?
...
Question: How many degrees of freedom does the table have?
...
A simple technique is to save your datafile within SPSS in Stata format.
